...
if (monthNumber == now.getMonth()){
        createdElement = "span";
        var day = now.getDate();
        childElements[(day+spacing)-1].innerHTML = `<span class="active glow">${day}</span>`; //orignial
...
currentMonthStyle.background = eval( `colorsOfTheMonth[monthNumber].${Object.keys(colorsOfTheMonth[monthNumber])}`); //Default
