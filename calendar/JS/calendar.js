...
update = () => {
        ...
        // const colorsOfTheMonth = [{"January":"rgba(153, 193, 220, var(--background-opacity,1))"}, {"February":"rgba(224, 222, 227, var(--background-opacity,1))"}, {"March":"rgba(111, 192, 177, var(--background-opacity,1))"}, {"April":"rgba(218, 222, 181, var(--background-opacity,1))"}, {"May":"rgba(205, 103, 102, var(--background-opacity,1))"}, {"June":"rgba(189, 218, 87, var(--background-opacity,1))"}, {"July":"rgba(166, 193, 225, var(--background-opacity,1))"}, {"August":"rgba(255, 215, 157, var(--background-opacity,1))"}, {"September":"rgba(208, 190, 85, var(--background-opacity,1))"}, {"October":"rgba(231, 148, 36, var(--background-opacity,1))"}, {"November":"rgba(171, 183, 187, var(--background-opacity,1))"}, {"December":"rgba(224, 232, 219, var(--background-opacity,1))"}];

        // const colorsOfTheMonth = [{"January":"rgba(var(--color-of-the-month), var(--background-opacity,1))"}, {"February":"rgba(var(--color-of-the-month), var(--background-opacity,1))"}, {"March":"rgba(var(--color-of-the-month), var(--background-opacity,1))"}, {"April":"rgba(var(--color-of-the-month), var(--background-opacity,1))"}, {"May":"rgba(var(--color-of-the-month), var(--background-opacity,1))"}, {"June":"rgba(var(--color-of-the-month), var(--background-opacity,1))"}, {"July":"rgba(var(--color-of-the-month), var(--background-opacity,1))"}, {"August":"rgba(var(--color-of-the-month), var(--background-opacity,1))"}, {"September":"rgba(var(--color-of-the-month), var(--background-opacity,1))"}, {"October":"rgba(var(--color-of-the-month), var(--background-opacity,1))"}, {"November":"rgba(var(--color-of-the-month), var(--background-opacity,1))"}, {"December":"rgba(var(--color-of-the-month), var(--background-opacity,1))"}];
...
for (var i = 0; i < monthsOfTheYear.length; i++) {
        if (monthNumber < 1) {
                ...
                dayOfTheWeek += (monthsOfTheYear[1].February === 29) ? 2 : 1; // May be false fix-Default: dayOfTheWeek++;
        } else {
                monthNumber--;
        }
